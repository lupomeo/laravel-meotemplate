    ...
    <ul class="nav flex-column pt-3 pt-md-0">
      ...
      <li class="nav-item {{ Request::segment(1) == 'students' ? 'active' : '' }}">
        ...
        <span class="sidebar-icon"><i class="fab fa-laravel me-2" style="color: #fb503b;"></i></span>
          ...
          <span class="sidebar-text">Gestione Studenti</span>
        </a>
      </li>
      <li class="nav-item {{ Request::segment(1) == 'usersm' ? 'active' : '' }}">
        <a href="/usersm" class="nav-link">
        <span class="sidebar-icon"><svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
              xmlns="http://www.w3.org/2000/svg">
      ...
      <li class="nav-item {{ Request::segment(1) == 'profile' ? 'active' : '' }}">
        ...
        <span class="sidebar-icon"><svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
          ...
          <span class="sidebar-text">Profilo</span>
        </a>
      </li>
